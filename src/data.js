...
export const stateDescriptions = {
  hyperarousal: {
    ...
    actions: [
      { label: "SETTLE", url: "https://www.livingrevively.com/resilience-resources?tab=Settle" },
      { label: "RESILIENCE RESOURCES", url: "https://www.livingrevively.com/resilience-resources?tab=Main" }
    ]
  },
  ...
  ventral_vagal: {
    ...
    actions: [
      { label: "VAGAL CONDITIONING", url: "https://www.livingrevively.com/resilience-resources?tab=Vagal Conditioning" },
      { label: "RESILIENCE RESOURCES", url: "https://www.livingrevively.com/resilience-resources?tab=Main" }
    ]
  },
  low_activation: {
    ...
    actions: [
      { label: "BOOST", url: "https://www.livingrevively.com/resilience-resources?tab=boost" },
      { label: "RESILIENCE RESOURCES", url: "https://www.livingrevively.com/resilience-resources?tab=Main" }
    ]
  },
  hypoarousal: {
